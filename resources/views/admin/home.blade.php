		...
		<div class="card">
		  <div class="image-container">
			<a href="{{ route('detailsP', ['id' => $product->id]) }}">
			  <img src="{{ asset('images/categories/pcgamer/' . $product->img) }}" alt="Product Image">
			</a>
		  </div>
